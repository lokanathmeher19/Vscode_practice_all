# Variables — `var`, `let`, and `const` — Easy Step-by-Step — Easy Step-by-Step

## Goal
Learn the main idea of 'Variables — `var`, `let`, and `const` — Easy Step-by-Step' with short steps.
...
## Summary
Learn the main idea of 'Variables — `var`, `let`, and `const`' with short steps.
...
# Variables — `var`, `let`, and `const` — Easy Step-by-Step
