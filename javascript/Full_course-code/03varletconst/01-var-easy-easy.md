# var, let and const — Easy Step-by-Step — Easy Step-by-Step

## Goal
Learn the main idea of 'var, let and const — Easy Step-by-Step' with short steps.
...
```js
var name = "Biswa";
console.log(name); //output: Biswa
```

## Summary
Learn the main idea of 'var, let and const' with short steps.
...
# var, let and const — Easy Step-by-Step
...
//good:
{
    ...
    console.log("My name is " + name + " and I love " + hobby); // output: My name is Biswa and I love programming
}
//bad
{
...
```js
const name = "Biswa"; //good
let name = "Biswa"; //fine but const is better because we know that the value of name will not change
var name = "Biswa"; //bad
```
