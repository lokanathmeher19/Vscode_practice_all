# Changing HTML Classes using JavaScript: className and classList — Easy Step-by-Step — Easy Step-by-Step

## Goal
Learn the main idea of 'Changing HTML Classes using JavaScript: className and classList — Easy Step-by-Step' with short steps.
...
## Summary
Learn the main idea of 'Changing HTML Classes using JavaScript: className and classList' with short steps.
...
# Changing HTML Classes using JavaScript: className and classList — Easy Step-by-Step
