# Practice Set 1 — Easy Step-by-Step — Easy Step-by-Step

## Goal
Learn the main idea of 'Practice Set 1 — Easy Step-by-Step' with short steps.
...
let name = "Biswa";
let age = 29;
console.log(name + age); // "Biswa29"
```

## Summary
Learn the main idea of 'Practice Set 1' with short steps.
...
# Practice Set 1 — Easy Step-by-Step
