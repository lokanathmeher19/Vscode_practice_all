# String Methods — Easy Step-by-Step — Easy Step-by-Step

## Goal
Learn the main idea of 'String Methods — Easy Step-by-Step' with short steps.
...
## Summary
Learn the main idea of 'String Methods' with short steps.
...
# String Methods — Easy Step-by-Step
...
```js
let name = "Biswa";
console.log(name.toUpperCase()); // Output: Biswa
console.log(name.toLowerCase()); // Output: Biswa
```
## slice()
...
```js
let spacedName = "       Biswa        ";
console.log(spacedName.trim()); // Output: Biswa
```
## indexOf()
...
console.log(upperCaseName); // Output: Biswa
console.log(name); // Output: Biswa (original string is unchanged)
```
