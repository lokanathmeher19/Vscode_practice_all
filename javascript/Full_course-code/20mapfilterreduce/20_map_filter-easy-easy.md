# map() — Easy Step-by-Step — Easy Step-by-Step

## Goal
Learn the main idea of 'map() — Easy Step-by-Step' with short steps.
...
## Summary
Learn the main idea of 'map()' with short steps.
