# Strings — Easy Step-by-Step — Easy Step-by-Step

## Goal
Learn the main idea of 'Strings — Easy Step-by-Step' with short steps.
...
## Example
```js
let name = "Biswa";         //correct
let friend = 'Prakash'      //correct
let wrong = 'Biswa";        //wrong, never do this!
```

## Summary
Learn the main idea of 'Strings' with short steps.
